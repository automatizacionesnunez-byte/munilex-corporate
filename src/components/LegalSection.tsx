...
export const LegalSection = () => {
  return (
    <section id="legal" className="py-24 md:py-28 relative bg-[#050608] border-t border-white/5">
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        <div className="max-w-3xl mb-12">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs font-bold text-white uppercase tracking-widest mb-4">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <article id="aviso-legal" className="rounded-[2rem] bg-[#111827] border border-white/10 p-6 sm:p-7">
            <div className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mb-5 text-slate-200">
              <Scale className="w-6 h-6" />
            </div>
            <h3 className="text-xl font-manrope font-black text-white uppercase mb-3">Aviso legal</h3>
          ...
          <article id="privacidad" className="rounded-[2rem] bg-[#111827] border border-white/10 p-6 sm:p-7">
            <div className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mb-5 text-slate-200">
              <Mail className="w-6 h-6" />
            </div>
            <h3 className="text-xl font-manrope font-black text-white uppercase mb-3">Política de privacidad</h3>
            <p className="text-sm text-white/60 leading-relaxed mb-4">
          ...
          <article id="cookies" className="rounded-[2rem] bg-[#111827] border border-white/10 p-6 sm:p-7">
            <div className="w-12 h-12 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mb-5 text-slate-200">
              <Cookie className="w-6 h-6" />
            </div>
            <h3 className="text-xl font-manrope font-black text-white uppercase mb-3">Política de cookies</h3>
            <p className="text-sm text-white/60 leading-relaxed mb-4">
