...
export const ComparisonSection: React.FC<ComparisonSectionProps> = ({ onOpenContact, variant }) => {
  const copy = {
    academias: {
      ...
      intro: 'Compara el coste real de construir desde cero frente a arrancar con una plataforma lista para vender, operar y escalar.',
      ctaTitle: '¿Quieres verlo aplicado a tu academia?',
      ctaBody: 'Agenda una sesión breve y te mostramos qué gana tu centro en tiempo, margen y control.',
    ...
    ingles: {
      ...
      intro: 'Compara una solución que ya viene preparada para progreso por niveles, práctica guiada y seguimiento de resultados.',
      ctaTitle: '¿Quieres ver la comparación con tu academia?',
      ctaBody: 'Te mostramos cómo ordenar el progreso, la práctica y la rentabilidad sin perder tu marca.',
    ...
    otros: {
      ...
      ctaBody: 'Te enseñamos el enfoque más útil según tu tipo de centro y tus procesos.',
      button: 'Solicitar Demostración',
    },
  }[variant];
  ...
  const comparisons = [
    {
      ...
      traditional: 'Alta inversión inicial y meses de desarrollo antes de vender',
