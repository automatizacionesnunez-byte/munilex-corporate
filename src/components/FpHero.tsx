    ...
    <section className="relative pt-32 pb-20 md:pt-44 md:pb-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10 relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto">
          ...
          >
            La plataforma integral para centros de FP: <strong className="text-white font-semibold">Simulaciones de Roleplay laboral por voz y texto</strong>, tutoría curricular 24/7, generador de exámenes tipo test y flashcards, panel docente y acompañamiento emocional para la prevención del estrés escolar.
          </motion.p>
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all flex items-center gap-1.5 cursor-pointer ${
                  activeFpTab === 'emotional'
                    ? 'bg-purple-400 text-black shadow-md font-bold'
                    : 'text-white/60 hover:text-white'
                }`}
              >
            ...
            <AnimatePresence mode="wait">
              ...
              {activeFpTab === 'exam' && (
                ...
                >
                  ...
                  <div className="p-4 rounded-xl bg-white/5 text-xs text-white/80 space-y-3">
                    <div className="flex justify-between items-center pb-2 border-b border-white/5">
                      <span className="font-bold text-white">Módulo: Gestión Financiera · Evaluación 2ª</span>
                      <span className="text-emerald-400 font-mono text-[11px]">Generado en 2.3s</span>
                    </div>
              ...
              {activeFpTab === 'emotional' && (
                ...
                >
                  <div className="md:col-span-6 bg-[#080d15] p-6 rounded-2xl border border-white/5">
                    ...
                    <div className="p-3.5 bg-purple-950/20 border border-purple-500/20 rounded-xl text-xs text-purple-200 leading-relaxed mb-3">
                    ...
                    <div className="grid grid-cols-4 gap-2 text-center text-xs">
                      <div className="p-2 bg-white/5 rounded-lg text-white/70">😊 Motivado</div>
                      <div className="p-2 bg-white/5 rounded-lg text-white/70">😐 Concentrado</div>
                      <div className="p-2 bg-purple-500/20 border border-purple-500/40 rounded-lg text-purple-200 font-bold">😰 Con Estrés</div>
                      <div className="p-2 bg-white/5 rounded-lg text-white/70">😴 Cansado</div>
                    </div>
                  </div>
