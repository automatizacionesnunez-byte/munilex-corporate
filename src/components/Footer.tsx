      ...
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-white/40">
          ...
          <div className="flex items-center gap-6">
            <a href="#contact" className="hover:text-white transition-colors">Aviso Legal</a>
            <a href="#contact" className="hover:text-white transition-colors">Política de Privacidad</a>
            <a href="#contact" className="hover:text-white transition-colors">Términos B2B</a>
            <a href="#contact" className="hover:text-white transition-colors">Cumplimiento ENS</a>
          </div>
        </div>
      </div>
    </footer>
